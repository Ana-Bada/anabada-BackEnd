...
public class NotificationService {
    ...
    public NotificationBadgeResponseDto checkBadge(UserDetailsImpl userDetails){
        List<NotificationEntity> notificationEntityList = notificationRepository
                .findAllByUserUserIdOrderByCreatedAtDescBadgeDesc(userDetails.getUser().getUserId());
    ...
    public Page<NotificationResponseDto> getNotificationList(UserDetailsImpl userDetails, int page, int size) {
        ...
        Page<NotificationResponseDto> notificationResponseDtoList = notificationRepository
                .findAllByUserUserIdOrderByCreatedAtDescBadgeDesc(userDetails.getUser().getUserId(), pageable);
